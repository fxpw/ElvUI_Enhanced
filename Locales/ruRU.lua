...
L["Hidden"] = "Скрыть"
L["No action"] = "Ничего"
L["None of the previous ones"] = "В остальных случаях"
L["Party"] = "Группа (ПП на 5 игроков)"
L["PvP"] = "PvP"
L["Raid"] = "Рейд"
L["Arena"] = "Арена"
L["Visibility State"] = "Состояния видимости"
L["Watch Frame"] = "Список заданий"
L["Display quest levels at Quest Tracker."] = "Показывать уровень квестов в трекере заданий."
...
L["CHAT_MSG_BATTLEGROUND"] = "Поле боя"
L["CHAT_MSG_BATTLEGROUND_LEADER"] = "Лидер поля боя"
L["CHAT_MSG_CHANNEL"] = "Каналы"
L["CHAT_MSG_SAY"] = "Сказать"
L["CHAT_MSG_YELL"] = "Крик"
L["CHAT_MSG_MONSTER_SAY"] = "Разговор монстра"
L["CHAT_MSG_MONSTER_YELL"] = "Крик монстра"
L["Chat Bubbles Group"] = "Настройки вспылвающих облачек"
